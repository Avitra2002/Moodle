...
class theme_boost_core_renderer extends core_renderer {
    public function standard_top_of_body_html() {
        ...
        $content = parent::standard_top_of_body_html();

        $context = context_system::instance();
        if (is_siteadmin() || has_capability('moodle/course:update', $context)) {
            $reportlinks = '<div class="header-report-links" style="margin:10px;">'
                . '<a href="/local/report1/index.php" style="margin-right:10px;">Report 1</a>'
                . '<a href="/local/report2/index.php" style="margin-right:10px;">Report 2</a>'
                . '<a href="/local/report3/index.php" style="margin-right:10px;">Report 3</a>'
                . '<a href="/local/report4/index.php">Report 4</a>'
                . '</div>';
            $content .= $reportlinks;
        }
